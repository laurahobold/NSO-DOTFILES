...
local title_widget = wibox.widget {
  markup = '<span color="' ..
      color.blueish_white .. '" font="Ubuntu Nerd Font bold 10">' .. "Nothing Playing" .. '</span>',
  align = 'left',
  valign = 'top',
  widget = wibox.widget.textbox,
...
local artist_widget = wibox.widget {
  markup = '<span color="' ..
      color.white .. '" font="Ubuntu Nerd Font 9">' .. "Unknown Artist" .. '</span>',
  align = 'left',
  valign = 'bottom',
  widget = wibox.widget.textbox,
...
playerctl:connect_signal("metadata",
  function(_, title, artist, album_path, album, new, player_name)
    ...
    artist_widget:set_markup_silently('<span color="' ..
      color.white .. '" font="Ubuntu Nerd Font 9">' .. artist .. '</span>')
  end)
...
button:buttons(gears.table.join(
  awful.button({}, 1, function()
    ...
    if is_playing then
      if title_widget.markup == '<span color="' .. color.blueish_white .. '" font="Ubuntu Nerd Font bold 10">' .. "Nothing Playing" .. '</span>' then

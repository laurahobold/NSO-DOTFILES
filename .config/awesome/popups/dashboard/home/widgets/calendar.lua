...
local sep = wibox.widget {
  markup       = '<span color="' ..
      color_list.green .. '" font="DinkieBitmap 15">' .. '' .. '</span>',
  font         = "Ubuntu Nerd Font 14",
  widget       = wibox.widget.textbox,
  fg           = color_list.bg_blackest,
  forced_width = dpi(70),
  align        = 'center',
}

local hour_clock = wibox.widget.textclock(
  '<span color="' .. color_list.yellow .. '" font="DinkieBitmap 15"> %H </span>', 10)

local minute_clock = wibox.widget.textclock(
  '<span color="' .. color_list.yellow .. '" font="DinkieBitmap 15"> %M </span>', 10)

local date_text = wibox.widget.textclock(
  '<span color="' .. color_list.magenta .. '" font="DinkieBitmap 15"> %a, %d </span>', 10)
